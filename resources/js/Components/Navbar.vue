...
<template>
    <nav
        class="bg-gray-900 border-gray-700 text-gray-300
                lg:bg-white lg:border-gray-100 lg:text-gray-500
                 dark:border-gray-800 dark:bg-gray-900 border-b dark:text-gray-300
            ">
                                ...
                                <template #trigger>
                                    <span class="inline-flex rounded-md">
                                        ...
                                        <button type="button"
                                            ...
                                            <span v-show="$page.props.auth.user.email_verified_at && $page.props.auth.user.id === 1" class="flex items-center justify-start text-sm truncate">
                                                {{ version }}
                                            </span>
